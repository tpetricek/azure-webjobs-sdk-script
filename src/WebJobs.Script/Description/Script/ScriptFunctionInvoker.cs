...
namespace Microsoft.Azure.WebJobs.Script.Description
{
    ...
    public class ScriptFunctionInvoker : FunctionInvokerBase
    {
        ...
        private static ScriptType[] _supportedScriptTypes = new ScriptType[] { ScriptType.Powershell, ScriptType.WindowsBatch, ScriptType.Python, ScriptType.PHP, ScriptType.Bash };
